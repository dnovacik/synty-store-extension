...
import { UAS_POLYGON_SERIES_LINK, UAS_SIMPLE_SERIES_LINK, NOTIFICATIONS_REQUEST } from "./../constants";
...
const syncNotification = (success: boolean, origin: PackOrigin, type: PackType) => {
  const options = {
    type: "basic",
